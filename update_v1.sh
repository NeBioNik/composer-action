...
for version in ${VERSIONS}; do
    ...
    echo "FROM ghcr.io/nebionik/composer-action:${version}-v1" >> ${version}/v1/install/Dockerfile
...
echo "FROM nebionik/composer-action:${LATEST_VERSION}-v1" >> v1/install/Dockerfile
